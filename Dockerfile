...
# Download package
RUN curl http://static.imply.io/release/imply-1.0.1-e5be862.tar.gz | tar -C /root -xzf -
...
ENTRYPOINT ["/root/imply-1.0.1-e5be862/bin/supervise", "-c", "/root/imply-1.0.1-e5be862/conf/supervise/quickstart.conf"]
